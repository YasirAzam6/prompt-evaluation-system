...
//           <button
//             onClick={toggleChat}
//             className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-full shadow-lg hover:shadow-2xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center"
//           >
...
//             <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-md">
//               Chatbot AI
//             </div>
//           </div>
//         </div>
...
//         {!isMinimized && (
//           <>
//             <div className="flex-1 h-80 overflow-y-auto p-4 space-y-4 bg-gray-50 custom-scrollbar">
...
//                     rows="1"
//                     className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none placeholder-gray-500"
...
//                   onClick={sendMessage}
//                   disabled={!input.trim()}
//                   className="w-9 h-9 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:from-gray-300 disabled:to-gray-400 text-white rounded-xl transition-all duration-200 flex items-center justify-center disabled:cursor-not-allowed"
//                 >
